  ...
  return (
    <>
      ...
      <div className="chapter">
        ...
        <article>
          <p>
            No front end eu uso React. Já usei babel e webpack, mas atualemente uso vite para gerar
            o bundle. Vite utiliza funcionalidades atualizadas dos browsers, como javascript
            modules.
          </p>

          <p>
            Para estilização dou preferência para o styled components. Não tenho problema nenhum em
            usar css puro ou sass. Minha preferência por styled components se dá por poder utilizar
            lógica dentro do css.
          </p>
        </article>
      </div>
    </>
