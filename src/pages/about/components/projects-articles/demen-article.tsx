  ...
  return (
    <article>
      ...
      <p>
        ...
        Youtube uma plataforma ineficiente para o aprendizado. A empresa decidiu
        monetizar o Youtube com clickbaits e bolhas de conteúdo. Ao pesquisar
        sobre um assunto no Youtube, ele apresenta alguns vídeos relacionados à
        palavra chave, e então começa a mostrar vídeos totalmente desalinhados
        com a busca, mas relacionados com conteúdos diversos assistidos
        anteriormente como futebol ou política.
      </p>
      ...
      <p>
        ...
        principal mecanismo de busca para vídeo aulas. A tendencia é de que
      ...
      <p>
        ...
        é que educação não da muita view, para o profissional que está gastando
        tempo criando conteúdo gratuito não alcançar ninguém é desestimulante.
        Existem canais grandes de educação no Youtube, mas para cada canal
        grande, existem centenas de canais pequenos que não aparecem nas buscas
        para que o usuário se distraia e volte a discutir política.
      </p>
      <p>
        A idéia inicial do projeto é criar um banco de dados, e usar a API do
        próprio Youtube para incorporar o vídeo na plataforma. A monetização e a
        view vai para o autor do vídeo. A nossa plataforma daria todos os
        créditos para o responsável. O demen só faz a ponte entre aluno e
        professor.
      </p>
      <p>
