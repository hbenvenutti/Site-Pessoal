...
function DemenArticle(): ReactElement {
  return (
    <article>
      ...
      <p>
        Eu estou desenvolvendo (devagar) uma aplicação para aglomerar conteúdo de qualidade. A ideia
        é criar um banco de dados com material e vídeo aulas gratuitas já disponíveis na Internet.
      </p>

      <p>
        Hoje em dia é possível encontrar aulas sobre qualquer conteúdo, mas dificilmente com a mesma
      ...
      <p>
        O segundo problema que eu observo é o de que o Google vem tornando o Youtube uma plataforma
        ineficiente para o aprendizado. A empresa decidiu monetizar o Youtube com clickbaits e
      ...
      <p>
        ...
        profissional que está gastando tempo criando conteúdo gratuito não alcançar ninguém é
        desestimulante. Existem canais grandes de educação no Youtube, mas para cada canal grande,
        existem centenas de canais pequenos que não aparecem nas buscas para que o usuário se
        distraia e volte a discutir política.
      </p>
      <p>
        A idéia inicial do projeto é criar um banco de dados, e usar a API do próprio Youtube para
        incorporar o vídeo na plataforma. A monetização e a view vai para o autor do vídeo. A nossa
        plataforma daria todos os créditos para o responsável. O demen só faz a ponte entre aluno e
        professor.
      </p>
      <p>
        Em um segundo momento, seria disponibilizada uma API para que os professores adicionassem
        seu vídeos e materiais ao Demen.
      </p>
      <p>
        Existe também a possibilidade de que após o Demen estar no ar, seja implementado um meio
        para que sistemas tutores inteligentes usem o banco de dados para apresentar conteúdo aos
        seus alunos.
      </p>
    </article>
  );
